    ...
    do
      ...
      |> assign(
        [
          ...
          current_year_gross_profit: Orders.total_gross_profit(year: this_year),
          current_year_net_profit: Orders.total_net_profit(year: this_year),
          ...
          stamps_in_orders_this_month: Orders.total_stamps_in_orders(year: this_year, month: this_month),
